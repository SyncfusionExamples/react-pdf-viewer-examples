...
        public IActionResult PrintImages([FromBody] Dictionary<string, string> jsonObject)
        ...
        [HttpPost("ApplyRedaction")]
        /*        [Microsoft.AspNetCore.Cors.EnableCors("MyPolicy")]*/
        [Route("[controller]/ApplyRedaction")]
        //Post action for downloading the PDF documents
        public IActionResult ApplyRedaction([FromBody] Dictionary<string, string> jsonObject)
        {
            PdfRenderer pdfviewer = new PdfRenderer(_cache);
            string flatterString = "";
            string documentBase = pdfviewer.GetDocumentAsBase64(jsonObject);
            ...
            if (base64String != null || base64String != string.Empty)
            {
                ...
                foreach (PdfLoadedPage loadedPage in loadedDocument.Pages)
                {
                    ...
                    foreach (PdfLoadedAnnotation annotation in loadedPage.Annotations)
                    {
                        ...
                        if (annotation is PdfLoadedRectangleAnnotation)
                        {
                            ...
                            PdfRedaction redaction = new PdfRedaction(annotation.Bounds, Syncfusion.Drawing.Color.White);
                ...
                flatterString = "data:application/pdf;base64," + Convert.ToBase64String(stream1.ToArray());
                //System.IO.File.WriteAllBytes(path + "/ouptut.pdf", byteArray);
            }
            return Content(flatterString);
        }
